  ...
  return (
    <div className="overflow-hidden relative">
      <div className="relative z-1">
        <div className="md:mx-24 xs:mx-20">
          <div id="hero" className="relative">
            <div id="background" className="z-1 absolute -top-169 w-full">
              ...
              <div className="rounded-full h-872 w-872 bg-linear-gradiant mt-282 p-1.5 mx-auto relative xs:hidden md:block">
            ...
            <div id="main" className="z-10 relative">
              ...
              <div className="pt-80 flex flex-col items-center justify-center w-full relative">
                ...
                <h1 className="text-N500 md:text-5xl xs:text-4xl text-center font-headings font-extrabold pt-16 md:w-660 xs:w-[300px]">
                  The all-in-one licensing solution
                </h1>
                <h1 className="text-O01 text-md font-bodyText tracking-md pt-32 text-center">
                ...
                <div className="pt-56 flex gap-16">
                  <Button
                    ...
                    iconLeft="Play"
                  />
                  <Button title="Get Started" iconLeft="Right" />
                </div>
                <img
                ...
                <div className="flex flex-col gap-32 items-center justify-center">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-58 md:gap-32 xs:gap-16">
                    <img
          ...
          <div id="work" className="relative mt-42 z-10">
            ...
            <div id="main" className="z-50 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-16 pt-96">
                  ...
                  <div className="flex items-center gap-16">
                    ...
                    <div className="flex flex-col gap-20">
                      ...
                      <p className="text-md text-N100 font-botyText tracking-md">
                        Create an account on our platform as a licensee,
                        licensor, or agency to access our marketplace and
                        services.
                      </p>
                    </div>
                  </div>
                ...
                <div className="pt-128 pl-104 flex items-start justify-center">
                  <div className="flex items-center gap-16">
                    ...
                    <div className="flex flex-col gap-20">
                      ...
                      <p className="text-md text-N100 font-botyText tracking-md">
                        Connect with other companies directly through our
                        platform by sending a custom deal pitch. Negotiate the
                        license terms until you both reach an agreement in our
                        chat room.
                      </p>
                    </div>
                  </div>
        ...
        >
          ...
          <Button title="Get Start" iconLeft="Right" className=" z-[3]" />
        </div>
        <div
          id="copywrite"
      ...
      {openSignup && (
        <div className="bg-[rgba(0,0,0,0.6)] w-screen h-screen absolute z-50 top-0">
